...
public class Heart {
    ...
    public Heart(Context context, int type) {
    ...
    public void addBitmap() {
        ...
        switch (type) {
            case PINK:
                resId = R.drawable.icon_live_heart0;
                break;
            case CYAN:
                resId = R.drawable.icon_live_heart1;
                break;
            case GREEN:
                resId = R.drawable.icon_live_heart2;
                break;
            case YELLOW:
                resId = R.drawable.icon_live_heart3;
                break;
            case BLUE:
                resId = R.drawable.icon_live_heart4;
                break;
            default:
                resId = R.drawable.icon_live_heart0;
